        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isMoved) {
                    ...
                    layoutParams.rightMargin = ((WindowManager) getContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getWidth() - right;
//                    layoutParams.bottomMargin = bottom;
    ...
    public void startScroll(final int start, int end, final boolean isLeft) {
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(start, end).setDuration(500);
