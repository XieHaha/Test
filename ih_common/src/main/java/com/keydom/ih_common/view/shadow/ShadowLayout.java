package com.keydom.ih_common.view.shadow;
...
public class ShadowLayout extends FrameLayout {
    ...
    public void setLayoutBackground(int color) {
        if (layoutBackground_true != null) {
            throw new UnsupportedOperationException("使用了ShadowLayout_hl_layoutBackground_true" +
                    "属性，要与ShadowLayout_hl_layoutBackground属性统一为颜色");
        }
    ...
    public void setLayoutBackgroundTrue(int color) {
        if (layoutBackground != null) {
            throw new UnsupportedOperationException("使用了ShadowLayout_hl_layoutBackground" +
                    "属性，要与ShadowLayout_hl_layoutBackground_true属性统一为颜色");
        }
    ...
    protected void onFinishInflate() {
        ...
        if (mTextViewResId != -1) {
            ...
            if (mTextView == null) {
                throw new NullPointerException("ShadowLayout找不到hl_bindTextView，请确保绑定的资源id" +
                        "在ShadowLayout内");
            } else {
                if (textColor == -101) {
    ...
    public void gradient(Paint paint) {
        ...
        switch (angleFlag) {
            case 0://0°
                linearGradient = new LinearGradient(leftPadding, topPadding,
                        getWidth() - rightPadding, topPadding, colors, null, Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;

            case 1://45°
                linearGradient = new LinearGradient(leftPadding, getHeight() - bottomPadding,
                        getWidth() - rightPadding, topPadding, colors, null, Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;
            ...
            case 2://90°
                ...
                linearGradient = new LinearGradient(x_, getHeight() - bottomPadding, x_,
                        topPadding, colors, null, Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;

            case 3://135°
                linearGradient = new LinearGradient(getWidth() - rightPadding,
                        getHeight() - bottomPadding, leftPadding, topPadding, colors, null,
                        Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;
            case 4://180°
                linearGradient = new LinearGradient(getWidth() - rightPadding, topPadding,
                        leftPadding, topPadding, colors, null, Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;

            case 5://225°
                linearGradient = new LinearGradient(getWidth() - rightPadding, topPadding,
                        leftPadding, getHeight() - bottomPadding, colors, null,
                        Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;
            ...
            case 6://270°
                ...
                linearGradient = new LinearGradient(x, topPadding, x, getHeight() - bottomPadding
            ...
            case 7://315°
                linearGradient = new LinearGradient(leftPadding, topPadding,
                        getWidth() - rightPadding, getHeight() - bottomPadding, colors, null,
                        Shader.TileMode.CLAMP);
                paint.setShader(linearGradient);
                break;
    ...
    private void setBackgroundCompat(int w, int h) {
        if (isShowShadow) {
            ...
            Bitmap bitmap = createShadowBitmap(w, h, mCornerRadius, mShadowLimit, mDx, mDy,
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius,
                    getResources().getDimension(R.dimen.dp_0));
            mCornerRadius_leftTop =
                    attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius_leftTop, -1);
            mCornerRadius_leftBottom =
                    attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius_leftBottom, -1);
            mCornerRadius_rightTop =
                    attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius_rightTop, -1);
            mCornerRadius_rightBottom =
                    attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius_rightBottom, -1);
            ...
            if (mBackGroundColor_true != -101 && layoutBackground != null) {
                throw new UnsupportedOperationException("使用了ShadowLayout_hl_layoutBackground_true" +
                        "属性，必须先设置ShadowLayout_hl_layoutBackground属性。且设置颜色时，必须保持都为颜色");
            }

            if (layoutBackground == null && layoutBackground_true != null) {
                throw new UnsupportedOperationException("使用了ShadowLayout_hl_layoutBackground_true" +
                        "属性，必须先设置ShadowLayout_hl_layoutBackground属性。且设置图片时，必须保持都为图片");
            }
            ...
            if (stroke_color == -101 && stroke_color_true != -101) {
                throw new UnsupportedOperationException("使用了ShadowLayout_hl_strokeColor_true" +
                        "属性，必须先设置ShadowLayout_hl_strokeColor属性");
            }
            ...
            if (clickAbleFalseBackground != null) {
                if (clickAbleFalseBackground instanceof ColorDrawable) {
                    ColorDrawable colorDrawableClickableFalse =
                            (ColorDrawable) clickAbleFalseBackground;
            ...
            if (startColor != -101) {
                //说明设置了渐变色的起始色
                if (endColor == -101) {
                    throw new UnsupportedOperationException("使用了ShadowLayout_hl_startColor" +
                            "渐变起始色，必须搭配终止色ShadowLayout_hl_endColor");
                }
            }
            ...
            if (selectorType == 3) {
                ...
                if (mBackGroundColor == -101 || mBackGroundColor_true == -101) {
                    throw new NullPointerException("使用了ShadowLayout" +
                            "的水波纹，必须设置使用了ShadowLayout_hl_layoutBackground" +
                            "和使用了ShadowLayout_hl_layoutBackground_true属性，且为颜色值");
                }
    ...
    private Bitmap createShadowBitmap(int shadowWidth, int shadowHeight, float cornerRadius,
        ...
        if (mCornerRadius_leftBottom == -1 && mCornerRadius_leftTop == -1 && mCornerRadius_rightTop == -1 && mCornerRadius_rightBottom == -1) {
            ...
            float[] outerR = new float[]{leftTop, leftTop, rightTop, rightTop, rightBottom,
                    rightBottom, leftBottom, leftBottom};//左上，右上，右下，左下
            Path path = new Path();
                    ...
                    if (selectorType != 3) {
                        if (layoutBackground == null && layoutBackground_true == null) {
                            ...
                            if (stroke_color != -101) {
                                ...
                                int the_height_stoke =
                                        (int) (rectf.bottom - stroke_with / 2 - rectf.top - stroke_with / 2);
                                int trueCorner =
                                        (int) (trueHeight * the_height_stoke / 2 / the_height);

                                RectF rectFStroke = new RectF(rectf.left + stroke_with / 2,
                                        rectf.top + stroke_with / 2,
                                        rectf.right - stroke_with / 2,
                                        rectf.bottom - stroke_with / 2);
                                canvas.drawRoundRect(rectFStroke, trueCorner, trueCorner,
                                        paint_stroke);
                        ...
                        if (layoutBackground == null && layoutBackground_true == null) {
                            ...
                            if (stroke_color != -101) {
                                ...
                                int the_height_stoke =
                                        (int) (rectf.bottom - stroke_with / 2 - rectf.top - stroke_with / 2);
                                int trueCorner =
                                        (int) (mCornerRadius * the_height_stoke / the_height);
    ...
    private void setSpaceCorner(Canvas canvas, int trueHeight) {
        ...
        if (stroke_color != -101) {
            if (selectorType != 3) {
                ShapeDrawable mDrawables = new ShapeDrawable(new RoundRectShape(outerR, null,
                        null));
                ...
                mDrawables.setBounds(leftPadding, topPadding, getWidth() - rightPadding,
                        getHeight() - bottomPadding);
                mDrawables.draw(canvas);

                float[] outerR_stroke = getCornerValueOther(trueHeight, (int) stroke_with);
                ShapeDrawable mDrawablesStroke =
                        new ShapeDrawable(new RoundRectShape(outerR_stroke, null, null));
                ...
                mDrawablesStroke.setBounds((int) (leftPadding + stroke_with / 2),
                        (int) (topPadding + stroke_with / 2),
                        (int) (getWidth() - rightPadding - stroke_with / 2),
                        (int) (getHeight() - bottomPadding - stroke_with / 2));
    ...
    private void ripple(float[] outRadius) {
        ...
        RippleDrawable rippleDrawable = new RippleDrawable(colorStateList, contentDrawable,
                maskDrawable);
    ...
    public void setmBackGround(Drawable drawable) {
        if (firstView != null && drawable != null) {
            if (mCornerRadius_leftTop == -1 && mCornerRadius_leftBottom == -1 && mCornerRadius_rightTop == -1 && mCornerRadius_rightBottom == -1) {
                //                GlideRoundUtils.setRoundCorner(firstView, drawable,
                //                mCornerRadius);
            } else {
                int leftTop;
                if (mCornerRadius_leftTop == -1) {
                ...
                //                GlideRoundUtils.setCorners(firstView, drawable, leftTop,
                //                leftBottom, rightTop,
                //                        rightBottom);
            }
        }
