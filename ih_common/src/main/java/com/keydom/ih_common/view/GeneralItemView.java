...
public class GeneralItemView extends RelativeLayout {
    ...
    public GeneralItemView(Context context, @Nullable AttributeSet attrs) {
        ...
        int titleStrResid = attrs.getAttributeResourceValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_common.view", "itemTitle",-1);
        String titleStr = attrs.getAttributeValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_common.view", "itemTitle");
        int leftImg = attrs.getAttributeResourceValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_common.view", "leftImg",-1);
        int rightImg = attrs.getAttributeResourceValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_common.view", "rightImg",-1);
        setLeftImg(leftImg);
