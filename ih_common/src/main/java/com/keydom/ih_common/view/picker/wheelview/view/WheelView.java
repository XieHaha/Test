package com.keydom.ih_common.view.picker.wheelview.view;
...
import com.keydom.ih_common.view.picker.wheelview.interfaces.IPickerViewData;
import com.keydom.ih_common.view.picker.wheelview.listener.LoopViewGestureListener;
import com.keydom.ih_common.view.picker.wheelview.listener.OnItemSelectedListener;
import com.keydom.ih_common.view.picker.wheelview.timer.InertiaTimerTask;
import com.keydom.ih_common.view.picker.wheelview.timer.MessageHandler;
import com.keydom.ih_common.view.picker.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textSize = getResources().getDimensionPixelSize(R.dimen.sp_18);//默认大小
