package com.keydom.ih_common.avchatkit.ui;
...
import com.keydom.ih_common.avchatkit.activity.AVChatActivity;
import com.keydom.ih_common.avchatkit.common.imageview.HeadImageView;
import com.keydom.ih_common.avchatkit.common.log.LogUtil;
import com.keydom.ih_common.avchatkit.common.util.NetworkUtil;
import com.keydom.ih_common.avchatkit.common.widgets.ToggleListener;
import com.keydom.ih_common.avchatkit.common.widgets.ToggleState;
import com.keydom.ih_common.avchatkit.common.widgets.ToggleView;
import com.keydom.ih_common.avchatkit.constant.AVChatExitCode;
import com.keydom.ih_common.avchatkit.constant.CallStateEnum;
import com.keydom.ih_common.avchatkit.controll.AVChatController;
import com.keydom.ih_common.avchatkit.module.AVChatControllerCallback;
...
public class AVChatAudioUI implements View.OnClickListener, ToggleListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.refuse) {
            ...
            if (isInSwitch) {
                Toast.makeText(context, "请耐心等待", Toast.LENGTH_SHORT).show();
            } else {
