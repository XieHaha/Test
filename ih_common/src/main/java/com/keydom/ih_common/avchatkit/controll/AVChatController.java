package com.keydom.ih_common.avchatkit.controll;
...
import com.keydom.ih_common.avchatkit.common.widgets.MultiSelectDialog;
...
public class AVChatController {
    ...
    public void toggleRecord(int type, final String receiverId, final RecordCallback callback) {
        if (isRecording) {
            ...
            selectDialog.setMessageTextColor(context.getResources().getColor(R.color.colorSearchEdt));
            ...
            selectDialog.addNegativeButton("取消", MultiSelectDialog.NO_TEXT_COLOR,
