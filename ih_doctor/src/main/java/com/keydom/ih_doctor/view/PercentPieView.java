...
public class PercentPieView extends View {
    ...
    private Rect centerBottomTextBound = new Rect();
    ...
    private Paint centerBottomTextPaint;
     ...
     * 中间字体大小
     */
    private float centerTextSize = 60;

    private float centerBottomTextSize = 40;
    ...
    private int centerBottomTextColor = Color.parseColor("#BBBBBB");
    ...
    private void init() {
        ...
        centerBottomTextPaint = new Paint();
        centerBottomTextPaint.setTextSize(centerBottomTextSize);
        centerBottomTextPaint.setAntiAlias(true);
        centerBottomTextPaint.setColor(centerBottomTextColor);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (measureWidthMode == MeasureSpec.AT_MOST
            ...
            setMeasuredDimension(Const.DEFAULT_WIDTH, measureHeightSize);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        radius = (Math.min(getMeasuredWidth(), getMeasuredHeight()) / 2) - 30;
    ...
    private void calculateAndDraw(Canvas canvas) {
        ...
        //绘制中心数字总和
        canvas.drawText(centerText, centerX - centerTextBound.width() / 2, centerY - centerTextBound.height() / 3, centerTextPaint);
        canvas.drawText("今日订单", centerX - centerBottomTextBound.width() / 2, centerY + centerTextBound.height() * 4 / 5, centerBottomTextPaint);
    }
    ...
    public void setData(int[] numbers, String[] names) {
        ...
        centerBottomTextPaint.getTextBounds("今日订单", 0, ("今日订单").length(), centerBottomTextBound);
        invalidate();
    }
    ...
    public void setCenterText(int amount) {
        centerText = String.valueOf(amount);
        invalidate();
    }
}
