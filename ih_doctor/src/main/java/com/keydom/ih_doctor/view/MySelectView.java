...
public class MySelectView extends RelativeLayout {
    ...
    public MySelectView(Context context, @Nullable AttributeSet attrs) {
        ...
        String hintStr = attrs.getAttributeValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_doctor.view", "itemHint");
        int leftImg = attrs.getAttributeResourceValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_doctor.view", "itemLeftImg", -1);
