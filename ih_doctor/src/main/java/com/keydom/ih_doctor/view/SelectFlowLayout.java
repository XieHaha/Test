...
public class SelectFlowLayout extends ViewGroup {

    /**
     * 存储行的集合，管理行
     */
    private List<Line> mLines = new ArrayList<>();
    private boolean addEndView = false;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (currentLine == null) {
                ...
                if (currentLine.canAddView(childView)) {
                    ...
                    if (!addEndView) {
                        SelectFlowLayout.this.addView(SelectFlowLayout.this.getEndView());
                        addEndView = true;
                    }
//                    //  添加到下一行
//                    currentLine = new Line(maxWidth, horizontalSpace);
...
*/
    ...
    public View getEndView() {
        ...
        View view = inflater.inflate(R.layout.end_view, null, true);
        return view;
    }

    private View getRightImg() {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.right_view, null, true);
        return view;
    }
