package com.keydom.ih_doctor.activity.health_manager.fragment;
...
import com.keydom.ih_doctor.activity.health_manager.controller.HealthMsgController;
import com.keydom.ih_doctor.activity.health_manager.view.HealthMsgView;
 ...
 * 健康管理 消息碎片
 */
public class HealthMsgFragment extends BaseControllerFragment<HealthMsgController> implements HealthMsgView {
     ...
     * 此处的EventBus
     * 事件在
     * {@link com.keydom.ih_doctor.adapter.GroupChatRecyclrViewAdapter#onUnReadCountEvent(RecentContactEvent)} )}中处理
     */
    @Override
    ...
    //        .MSG_CHATTING_ACCOUNT_ALL, SessionTypeEnum.None);
    //    }
    ...
    private void registerObservers(boolean register) {
        ...
        //        ImClient.getTeamChangedObservable().registerTeamDataChangedObserver
        //        (teamDataChangedObserver, register);
    ...
    TeamMemberDataChangedObserver teamMemberDataChangedObserver =
            new TeamMemberDataChangedObserver() {
                @Override
