...
import com.keydom.ih_doctor.activity.online_diagnose.DiagnoseOrderSelectActivity;
import com.keydom.ih_doctor.activity.online_diagnose.view.FillOutDiagnoseTriageApplyView;
 ...
 */
public class FillOutDiagnoseTriageApplyController extends ControllerImpl<FillOutDiagnoseTriageApplyView> implements View.OnClickListener, AdapterView.OnItemClickListener {
    @SingleClick(1000)
    @Override
