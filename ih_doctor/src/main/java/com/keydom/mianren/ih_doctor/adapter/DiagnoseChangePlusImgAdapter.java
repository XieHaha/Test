 ...
 */
public class DiagnoseChangePlusImgAdapter extends BaseAdapter {
    ...
    public DiagnoseChangePlusImgAdapter(Context context, List<String> list) {
            ...
            public void onClick(View v) {
                new GeneralDialog(context, "确定删除该图片？", new GeneralDialog.OnCloseListener() {
                    ...
                    public void onCommit() {
                        ...
                        DiagnoseChangePlusImgAdapter.this.notifyDataSetChanged();
                    }
                }).show();
            }
        });
