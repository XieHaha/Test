...
public class CircleImageWithBorderView extends ImageView {
    ...
    private int mBorderColor = 0xFFFFFFFF;//外边框的颜色

    public CircleImageWithBorderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
