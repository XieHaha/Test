...
import com.keydom.mianren.ih_doctor.activity.issue_information.controller.IssueNotificationController;
...
public class IssueNotificationActivity extends BaseControllerActivity<IssueNotificationController> implements IssueNotificationView {
    ...
    public static void startWithUpdate(Context context, int id) {
        Intent starter = new Intent(context, IssueNotificationActivity.class);
        starter.putExtra(com.keydom.mianren.ih_doctor.constant.Const.DATA, id);
        context.startActivity(starter);
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        notificationId = getIntent().getIntExtra(com.keydom.mianren.ih_doctor.constant.Const.DATA, DEFAULT_ID);
