...
public abstract class BaseScaleView extends View {
    ...
    protected void init(AttributeSet attrs) {
        ...
        mMax = ta.getInteger(LF_SCALE_MAX, 40);
        mScaleMargin = ta.getDimensionPixelOffset(LF_SCALE_MARGIN, 30);
        mScaleHeight = ta.getDimensionPixelOffset(LF_SCALE_HEIGHT, 30);
        ta.recycle();
