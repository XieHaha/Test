    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        conten_refresh_layout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                getController().getNurseServiceProjectByCateId(String.valueOf(nursingTypeId),
                        TypeEnum.REFRESH);
        ...
        nursingProjectAdapter = new NursingProjectAdapter(Type.ENABLESELCTEDLIST, dataList,
                new NursingProjectAdapter.onItemBtnClickListener() {
                    @Override
                    ...
                    public void onClickListener(NursingProjectInfo item) {
                        NursingProjectDetailActivity.start(getContext(),
