 ...
 * 检验适配器
 */
public class BodyCheckDetailAdapter extends BaseQuickAdapter<CheckoutResultListBean,
        BaseViewHolder> {
    /**
     * 构造方法
     */
    public BodyCheckDetailAdapter(@Nullable List<CheckoutResultListBean> checkoutResultList) {
