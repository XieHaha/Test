...
public class ArcView extends View {
    ...
    private void readAttr(AttributeSet set) {
        TypedArray typedArray = getContext().obtainStyledAttributes(set,
                R.styleable.PerfectArcView);
        mStartColor = typedArray.getColor(R.styleable.PerfectArcView_p_arc_startColor,
                Color.parseColor("#f9f9f9"));
        mEndColor = typedArray.getColor(R.styleable.PerfectArcView_p_arc_endColor,
                Color.parseColor("#f9f9f9"));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mLinearGradient = new LinearGradient(width / 2, 0, width / 2, mHeight, mStartColor,
    ...
    public void setColor(@ColorInt int startColor, @ColorInt int endColor) {
        ...
        mEndColor = endColor;
        mIsShowImage = false;
        mLinearGradient = new LinearGradient(mWidth / 2, 0, mWidth / 2, mHeight, mStartColor,
                mEndColor, Shader.TileMode.MIRROR);
        invalidate();
    }
