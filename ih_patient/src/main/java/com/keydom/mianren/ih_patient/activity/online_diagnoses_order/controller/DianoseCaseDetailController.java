...
import com.keydom.mianren.ih_patient.activity.online_diagnoses_order.view.DianoseCaseDetailView;
...
public class DianoseCaseDetailController extends ControllerImpl<DianoseCaseDetailView> {
    ...
    public void getDetail() {
        ApiRequest.INSTANCE.request(HttpService.INSTANCE.createService(DiagnoseApiService.class).getMedicalRecordInfo(getView().getQueryMap()), new HttpSubscriber<DiagnoseCaseBean>(getContext(), getDisposable(), false) {
            @Override
