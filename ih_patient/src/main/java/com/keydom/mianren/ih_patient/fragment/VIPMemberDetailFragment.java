...
import com.keydom.mianren.ih_patient.adapter.MemberFunctionAdapter;
import com.keydom.mianren.ih_patient.bean.IndexFunction;
import com.keydom.mianren.ih_patient.bean.VIPDetailBean;
import com.keydom.mianren.ih_patient.bean.event.ChargeMemberSuccess;
import com.keydom.mianren.ih_patient.fragment.controller.VIPMemberDetailController;
import com.keydom.mianren.ih_patient.fragment.view.VIPMemberDetailView;
    ...
    public void refreshData(VIPDetailBean data) {
        if (null != data) {
            ...
            if (null != data.getEndTime()) {
                ...
                mDateTv.setText(DateUtils.getDate(data.getEndTime(), DateUtils.YYYY_MM_DD));
            }
