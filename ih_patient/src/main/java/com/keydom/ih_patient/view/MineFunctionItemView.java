...
public class MineFunctionItemView extends RelativeLayout {
    ...
    public MineFunctionItemView(Context context, @Nullable AttributeSet attrs) {
        ...
        String titleStr = attrs.getAttributeValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_patient.view", "itemTitle");
        int titleStrResid = attrs.getAttributeResourceValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_patient.view", "itemTitle",-1);
        int iconImg = attrs.getAttributeResourceValue("http://schemas.android.com/apk/res-audo/com.keydom.ih_patient.view", "iconImg",-1);
        setIconImg(iconImg);
