package com.keydom.ih_patient.view.im_plugin;
...
import com.keydom.ih_patient.view.CustomRecognizerDialog;
...
public class VoiceInputPlugin implements IPluginModule {
    ...
    private RecognizerDialogListener mRecognizerDialogListener = new RecognizerDialogListener() {
        ...
        public void onError(SpeechError error) {
            ToastUtil.showMessage(App.mApplication,error.getPlainDescription(true));
