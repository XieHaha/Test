...
import com.keydom.ih_patient.adapter.OrderDoctorRegisterAdapter;
...
public class OrderDoctorRegisterActivity extends BaseControllerActivity<OrderDoctorRegisterController> implements OrderDoctorRegisterView {
    ...
    public static void start(Context context){
        context.startActivity(new Intent(context,OrderDoctorRegisterActivity.class));
    }
    ...
    private RelativeLayout top_layout,emptyLayout,hospital_area_layout;
    private LinearLayout search_layout,llLeftGoBack,llRightComplete;
    private TextView order_hospital_name_name,order_hospital_label_name,order_hospital_address_tv,emptyTv;
    ...
    public void showHospitalAreaPopupWindow() {
        if(areaList!=null&&areaList.size()>1){
            View view = LayoutInflater.from(getContext()).inflate(R.layout.general_popupwindow_layout,top_layout,false);
