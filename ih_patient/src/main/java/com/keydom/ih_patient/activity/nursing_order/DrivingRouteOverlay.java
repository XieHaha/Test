...
public class DrivingRouteOverlay extends OverlayManager {
     ...
     */
    public DrivingRouteOverlay(Context context, BaiduMap baiduMap) {
        super(baiduMap);
...
//        mRouteLine.getWayPoints();
        ...
        if (mRouteLine.getAllStep() != null
            ...
            for (int i = 0; i < stepNum; i++) {
                if (i == stepNum - 1) {
                    if (steps.get(i) != null && steps.get(i).getWayPoints() != null) {
...
//            }
            ...
            PolylineOptions option = new PolylineOptions().points(points).textureIndex(traffics)
                    ...
                    .color(getLineColor() != 0 ? getLineColor() : Color.argb(255, 132, 153, 245)).zIndex(0);
            if (isDotLine) {
